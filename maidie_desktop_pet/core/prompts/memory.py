...
def build_memory_extraction_prompt(message: str, response: str) -> str:
    ...
    return (
        ...
        "健康隐私或其他敏感信息。只允许提取用户消息中明确说出的内容；"
        "助手回复、助手使用的称呼、助手扮演的角色、历史回复风格和推断内容都不能记忆。"
        "只有用户明确说“叫我/称呼我/我叫”时才能提取姓名或昵称；"
        "只有用户明确要求某种人格、角色或说话风格时才能提取角色扮演偏好。"
        "问候、点按事件、临时问题和助手声称做过的事情不要记忆。"
